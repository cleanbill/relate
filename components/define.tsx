                ...
                <form >
                    <div className="mb-6">
                        ...
                        <div className="grid grid-cols-[12fr,0fr] gap-5">
                            <input ref={(e: HTMLInputElement) => shact(e, props.group)} defaultValue={props.group} onChange={e => change(props.setGroup, e)} type="text" id="groupField" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required />
                            <button title="New Group" type="button" onClick={() => props.setGroup()} className="butt-colour font-medium rounded-lg text-sm px-2 w-10 h-10 focus:outline-none ">
                    ...
                    <div className="mb-6">
                        ...
                        <div className="grid grid-cols-[12fr,0fr] gap-5">
                            <input ref={(e: HTMLInputElement) => shact(e, props.title)} onChange={e => change(props.setTitle, e)} 
                            ...
                            <button title="New Title" type="button" onClick={() => props.setTitle()} className="butt-colour font-medium rounded-lg text-sm px-2 w-10 h-10 focus:outline-none ">
                                <svg aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clipRule="evenodd"></path></svg>
                            </button>
                        </div>
                    </div>
