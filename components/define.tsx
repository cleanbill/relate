            ...
            <div className="font-normal p-12 text-gray-700 dark:text-gray-400">
                <form >
                    <div className="mb-6">
                        ...
                        <input ref={(e:HTMLInputElement) => shact(e, props.group)} defaultValue={props.group} onChange={e => props.setGroup(e.target.value)} type="text" id="group" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required />
                    </div>
                    <div className="mb-6">
                        <label className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Title</label>
                        <input ref={(e:HTMLInputElement) => shact(e, props.title)} onChange={e => props.setTitle(e.target.value)} defaultValue={props.title} type="text" id="group" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required />
                    </div>
                    ...
                    {props.fields.map((field, index: number) => (
                        <div key={index} className='grid grid-cols-3 gap-10'>
                            ...
                            <button type="button" onClick={() => props.take(index)} className="butt-colour font-medium rounded-lg text-sm px-2 w-10 h-10 focus:outline-none ">
                ...
                <div className='float-right' style={{ float: 'right' }}>
                    <button type="button" onClick={() => props.add()} className="butt-colour focus:ring-4  font-medium float-right rounded-lg text-sm w-8 p-1 focus:outline-none "> <svg aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clipRule="evenodd"></path></svg>
